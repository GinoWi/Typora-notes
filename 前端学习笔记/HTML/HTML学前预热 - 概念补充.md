...
3.  缓存文件夹中除了缓存图片，还缓存了一些`.js`、`.css`等文件，可以得出一个网页不是一个文件，而是由一堆文件组成，网页越复杂，组成网页的文件越多。
...
*   HTML就只有一个作用，他是**专门用来描述文本的语意**的，我们可以利用HTML来告诉浏览器哪些是标题，哪些是段落。
...
W3School官方文档：<https://www.w3school.com.cn>
